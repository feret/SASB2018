...
\end{minipage}
  ...
  \hspace*{3mm}\scalebox{0.6}{\includegraphics{generated_pictures/conflict_rg.pdf}}%
  \hspace*{3mm}\scalebox{0.6}{\includegraphics{generated_pictures/conflict_grs.pdf}}%
  \hspace*{3mm}\scalebox{0.6}{\includegraphics{generated_pictures/conflict_ggrs.pdf}}%
...
\begin{figure}
  \subfigure[Contact map.]%
  {\label{fig:egfr:gs:cm}\scalebox{0.4}{\includegraphics{generated_pictures/contact_map.pdf}}}
  \subfigure[Graph of site.]%
  {\label{fig:egfr:gs:gs}\scalebox{0.4}{\includegraphics{generated_pictures/egfr_graph_site.pdf}}}
