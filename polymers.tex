...
\begin{figure}
  ...
  \begin{minipage}{0.3\linewidth}
      \label{fig:abc:cm}
  \centering\scalebox{0.4}{\includegraphics{generated_pictures/abc_contact_map.pdf}}\vspace*{2.5mm}\smallskip\\%
\end{minipage}
  }
  \subfigure[Triangle \agentfont{ABC}.]{%
  \begin{minipage}{0.3\linewidth}
    \label{fig:abc:triangle}
  \centering\scalebox{0.4}{\includegraphics{generated_pictures/abc_triangle.pdf}}\vspace*{2.5mm}\smallskip\\%
\end{minipage}
  }
  ...
  \begin{minipage}{0.3\linewidth}
    ...
    \vspace*{0.6cm}
  \centering\scalebox{0.4}{\includegraphics{generated_pictures/abc_pattern.pdf}}\vspace*{0.5cm}\smallskip\\%
\end{minipage}}
...
\begin{figure}[t]
\subfigure[The $\Sigma$-graph $\graphsymb_{\textit{CM}}$.]{%
\label{fig:cm}
...
\subfigure[The $\Sigma$-graph $\graphsymb_{\textit{SP}}$.]{%
\label{fig:sigma}
\begin{minipage}{0.5\linewidth}%
