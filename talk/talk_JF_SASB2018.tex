...
\begin{enumerate}
  ...
  When models come from a more abstract specification language, some conflicts are often forgotten.

\vfill

  \item Understanding the model:

  Self-assembling of geant macro-molecules.
\end{enumerate}
