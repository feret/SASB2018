...
open Config
open Geometry
open Usual_signature_egfr

let empty = Usual_signature_egfr.signature_egfr
...
let _ = proj_flow_on_a_contact_map ~padding:5. ~file:"flow_species_proj_contact_map_" ~angle:e species_with_flow  contact_map

let _ = dump "species_frag2_proj_annotated_cm.dot" ~flags:["frag",2]
  (add_flow_cm (lift_site sigma_cm) (add_proj proj_inv trans_sp_with_cm))
let _ = dump "species_annotated_frag2_proj_annotated_cm.dot" ~flags:["frag",2;"flow",1]
